...
export interface getSeoulResidentPopulation_Param {
  STDR_YYQU_CD: string;               // 기준_년분기_코드
  TRDAR_SE_CD: string;                // 상권_구분_코드
  TRDAR_SE_CD_NM: string;             // 상권_구분_코드_명
  TRDAR_CD: string;                   // 상권_코드
  TRDAR_CD_NM: string;                // 상권_코드_명
  TOT_REPOP_CO: number;               // 총_상주_인구_수
  ML_REPOP_CO: number;                // 남성_상주_인구_수
  FML_REPOP_CO: number;               // 여성_상주_인구_수
  AGRDE_10_REPOP_CO: number;          // 연령대_10_상주_인구_수
  AGRDE_20_REPOP_CO: number;          // 연령대_20_상주_인구_수
  AGRDE_30_REPOP_CO: number;          // 연령대_30_상주_인구_수
  AGRDE_40_REPOP_CO: number;          // 연령대_40_상주_인구_수
  AGRDE_50_REPOP_CO: number;          // 연령대_50_상주_인구_수
  AGRDE_60_ABOVE_REPOP_CO: number;    // 연령대_60_이상_상주_인구_수
  MAG_10_REPOP_CO: number;            // 남성연령대_10_상주_인구_수
  MAG_20_REPOP_CO: number;            // 남성연령대_20_상주_인구_수
  MAG_30_REPOP_CO: number;            // 남성연령대_30_상주_인구_수
  MAG_40_REPOP_CO: number;            // 남성연령대_40_상주_인구_수
  MAG_50_REPOP_CO: number;            // 남성연령대_50_상주_인구_수
  MAG_60_ABOVE_REPOP_CO: number;      // 남성연령대_60_이상_상주_인구_수
  FAG_10_REPOP_CO: number;            // 여성연령대_10_상주_인구_수
  FAG_20_REPOP_CO: number;            // 여성연령대_20_상주_인구_수
  FAG_30_REPOP_CO: number;            // 여성연령대_30_상주_인구_수
  FAG_40_REPOP_CO: number;            // 여성연령대_40_상주_인구_수
  FAG_50_REPOP_CO: number;            // 여성연령대_50_상주_인구_수
  FAG_60_ABOVE_REPOP_CO: number;      // 여성연령대_60_상주_인구_수

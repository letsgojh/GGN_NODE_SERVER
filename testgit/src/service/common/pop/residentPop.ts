...
export type getResidentPopPerStore_Param ={
    resident : number;
}

export async function getResidentPopPerStore_commercial(auto : string, admin : string, industry : string) : Promise<getResidentPopPerStore_Param>{
    ...
    const ans : getResidentPopPerStore_Param = {
...
export async function getResidentPopPerStore_hinterland(auto : string, admin : string, industry : string) : Promise<getResidentPopPerStore_Param>{
    //지역의 상권이름 string[] 형태로 반환

import { getSeoulFloatingPopulation_commercial, getSeoulFloatingPopulation_hinterland, getSeoulMarketCount_commercial, getSeoulMarketCount_hinterland, } from '../../../domain/calledData.js';
...
export async function getFloatPopPerStore_commercial(auto, admin, industry) {
...
export async function getFloatPopPerStore_hinterland(auto, admin, industry) {
    //지역의 상권이름 string[] 형태로 반환

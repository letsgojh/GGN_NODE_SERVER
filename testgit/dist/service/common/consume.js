import { getSeoulFloatingPopulation_commercial, getSeoulCompanyPopulation_commercial, getResidentPopulation_commercial, getSeoulEstimateIncome_commercial, } from '../../domain/calledData.js';
import { getSanggwon_By_Region_commercial } from '../convenient_store/service.js';
export async function getConsume(auto, admin, name) {
